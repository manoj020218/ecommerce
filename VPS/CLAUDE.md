...
**SSH access**: `plink root@154.61.69.200` (password: `Vps@SmGym#2026`) via `"D:\plink_git.bat"`
...
SUPER_ADMIN_PASSWORD=JenixTest@2026!
...
- [ ] Change admin password — Production still uses `JenixTest@2026!`; change via Staff page
